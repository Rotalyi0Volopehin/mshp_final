...
class QuestMenuScene(Scene):
    def create_objects(self):
        self.quest_1 = Btn(self.game, (100, 100, 100, 40), Color.WHITE, "Квест 1", self.back_to_menu)
        ...
        self.button_back = Btn(self.game, (350, 500, 100, 40), Color.WHITE, "Меню", self.set_quest_1)
