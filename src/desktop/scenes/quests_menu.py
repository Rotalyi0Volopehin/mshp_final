...
class QuestMenuScene(Scene):
    def create_objects(self):
        ...
        self.quest_2 = Btn(self.game, (350, 100, 100, 40), Color.WHITE, "Квест 2", self.set_quest_2)
        ...
        self.objects = [self.button_back, self.quest_1, self.quest_2]

    def back_to_menu(self):
        self.set_next_scene(self.game.MENU_SCENE_INDEX)

    def set_quest_1(self):
        self.game.quest_index = "1"
