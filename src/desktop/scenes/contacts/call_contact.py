...
class CallContactScene(Scene):
    def create_objects(self):
        ...
        self.button_kurt = Btn(self.game, (450, 180, 100, 40), Color.WHITE, "Курт", self.set_kurt)
        self.button_kit = Btn(self.game, (450, 280, 100, 40), Color.WHITE, "Китти Прайд", self.set_kit)
        ...
        self.objects = [self.button_swan, self.button_exit, self.button_finch, self.button_krayn, self.button_smith,
                        self.button_kurt, self.button_kit]
