...
class MenuScene(Scene):
    def create_objects(self):
        ...
        self.button_quest = Btn(self.game, (350, 205, 100, 40), Color.WHITE, 'Квесты', self.set_quest_scene)
        self.button_map = Btn(self.game, (350, 255, 100, 40), Color.WHITE, 'Карта мира', self.set_map_scene)
