...
class GameOverScene(Scene):
    def __init__(self, game, game_model):
    ...
    def create_objects(self):
        if not user_info.online:
            text = "Игра окончена"
            color = Color.WHITE
        elif self.game_model.player_ids[user_info.user_id].team.defeated:
        ...
        menu_button = Btn(self.game, (350, 455, 100, 40), text="Меню", function=self.game.return_to_upper_scene)
