...
class GSInfoPlate(DrawObject):
    def __init__(self, game, pos_x, pos_y, play_func, get_gs_func, auto_update_period=-1, auto_update_func=None):
        super().__init__(game)
    ...
    def process_logic(self):
        if (self.waiting_for_first_turn_state_end_time is not None) and (self.waiting_for_first_turn_time_left <= 0):
            self.play_func()
