"""
Django settings for network_confrontation_web project.
...
DEBUG = bool(os.environ.get('NC_DEBUG', True))
...
ROOT_URLCONF = 'network_confrontation_web.urls'
...
if DEBUG:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get("NC_MYSQL_DATABASE", 'define me'),
            'USER': os.environ.get("NC_MYSQL_USER", 'define me'),
            'PASSWORD': os.environ.get("NC_MYSQL_PASSWORD", 'define me'),
            'HOST': os.environ.get("NC_MYSQL_HOST", 'localhost'),
            'PORT': os.environ.get("NC_MYSQL_PORT", '3306'),
        }
    }
