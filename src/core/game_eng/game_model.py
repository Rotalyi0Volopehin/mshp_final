...
def create_new_game_model(title: str, player_turn_period: int, teams_money_limit: int, players_data) -> GameModel:
    ...
    empty_tiles = [[0,0],[1,0],[2,0],[9,0],[10,0],[0,1],[1,1],[3,1],[9,1],[10,1],[0,2],[1,2],[4,2],[10,2],[0,3],[6,3],
                   [10,3],[0,4],[5,4],[3,5],[6,5],[8,5],[9,5],[0,6],[5,6],[0,7],[6,7],[10,7],[0,8],[1,8],[4,8],[10,8],
                   [0,9],[1,9],[3,9],[9,9],[10,9],[0,10],[1,10],[2,10],[9,10],[10,10]]
